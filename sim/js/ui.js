...
export function getUIRefs() {
  ...
  refs = {
    ...
    fdsCsvStats: byId("fdsCsvStats"),
    riskViewModeInput: byId("riskViewMode"),
    smokeSourceRateInput: byId("smokeSourceRate"),
    smokeDiffusionRateInput: byId("smokeDiffusionRate"),
    smokeSpreadMixInput: byId("smokeSpreadMix"),
    smokeDiagonalMixInput: byId("smokeDiagonalMix"),
    smokeDecayRateInput: byId("smokeDecayRate"),
    smokeSootYieldInput: byId("smokeSootYield"),
    smokeCoYieldInput: byId("smokeCoYield"),
    smokeHeatOfCombustionInput: byId("smokeHeatOfCombustion"),
    smokeExitVentInput: byId("smokeExitVent"),
    stairTypeInput: byId("stairType"),
    stairTravelCostInput: byId("stairTravelCost"),
    stairSmokeTransferInput: byId("stairSmokeTransfer"),
    stairCapacityInput: byId("stairCapacity"),
